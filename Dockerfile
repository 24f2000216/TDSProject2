...
RUN apt-get update && apt-get install -y \
    ...
    libdrm2 libexpat1 libgbm1 libglib2.0-0 libgtk-3-0 \
    ...
    lsb-release xdg-utils libatspi2.0-0 libcairo2 \
    libgdk-pixbuf-2.0-0 libxkbcommon0 \
...
RUN mkdir -p /app/.scraper_cache && chmod 777 /app/.scraper_cache
